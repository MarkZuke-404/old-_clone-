...
\33[1;33m█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█ 
\33[1;33m█  \33[m
\33[1;33m█  \33[mFacebook: SAKIB 
\33[1;33m█  \33[mWhatsApp: +9660531382117
...
def login_kontol():
	banner()
	print("""%s ●▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬● """%(h))
	print("""%s    \33[1;32mFACBOOK TOKEN  """%(h))
	print("""%s ●▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬● """%(h))
...
def menu(my_name):
	...
	print("""%s \33[m[02] \33[1;33mCEK SAKIB CRACK """%(h))
...
def passwrd():
	...
	print('')
	print("""%s ●▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬● """%(h))
	woi = input(x+'\33[1;96m•Ingin Menampilkan Opsi SAKIB Crack? (y/t) : ')
	if woi in ['y','Y']:
		cek_opsi()
	else:
		exit()
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [Sakib] %s/%s ~_~ [OK:%s] ^_^ [CP:%s] ~_~ %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
